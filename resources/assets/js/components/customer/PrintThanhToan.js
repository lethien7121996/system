...
class ComponentToPrint extends Component {
 ...
 var tongthanhtoan= 0
  ketquadieutrilist.forEach(tong => {
    ...
    document.getElementById("tongthanhtoan").innerHTML = tongthanhtoan.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".") + "đ"
    document.getElementById("thanhtoanconlai").innerHTML = tongthanhtoan.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".") + "đ"
    document.getElementById("tongdutoan").innerHTML = "Tổng dự toán: "+tongthanhtoan.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".") + "đ"
})
...
<div className="GOK0K1ECPBC">
      ...
      <div className="gwt-Label">In lúc {dateTime}</div>
        ...
        <div style={{display: 'flex', flexFlow: 'row nowrap', borderBottom: '4px solid #ddd'}}>
          ...
          <div style={{textAlign: 'right', alignSelf: 'flex-end', flexGrow: 1, textTransform: 'capitalize', fontSize: '10px', fontWeight: 300}}>
            ...
            <div className="GOK0K1ECLBC" style={{}}>
              ...
              <div style={{textTransform: 'lowercase'}}><i className="fa fa-envelope" style={{marginLeft: '10px', marginRight: '3px', color: '#999'}} />phongkhamnhakhoa@gmail.com</div>
            </div>
        ...
        <div className="GOK0K1ECECC">
          <div style={{flexBasis: '300px'}}><span style={{fontWeight: 600, marginRight: '5px'}}>Ngày sinh:</span> <span className="GOK0K1ECHCC">04/11/2020</span></div>
          <div style={{whiteSpace: 'nowrap'}}><span style={{fontWeight: 600, marginRight: '5px'}}>Giới tính:</span> <span className="GOK0K1ECHCC">Nam</span></div>
        </div>
        <div className="GOK0K1ECECC">
          <div style={{flexBasis: '300px'}}>
      ...
      <div className="GOK0K1ECHCC" id="hangdichvu">{tendichvu}</div>
        ...
        <div style={{marginTop: '15px', marginBottom: '5px', display: 'flex', flexFlow: 'row nowrap', alignItems: 'center', justifyContent: 'space-between'}}>
          ...
          <div style={{fontWeight: 300, fontSize: '13px'}} id="tongdutoan">Tổng dự toán: 0&nbsp;₫</div>
        </div>
        <div>
...
<div className="ProcedureItemView-amount" style={{textAlign: 'left'}}>
{cd.ghichu}
</div>
 <div className="ProcedureItemView-doctor">{cd.idbacsi}</div>


 <div className="ProcedureItemView-amount">{cd.chiphi.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".")}₫
        ...
        <div className="GOK0K1ECGCC" style={{border: '2px solid #777', display: 'inline-flex', float: 'right'}}>
          ...
          <div className="GOK0K1ECHBC" id="thanhtoanconlai">01&nbsp;₫</div>
        </div>
  ...
  const tendichvu = this.props.tendichvu
      return (
        ...
        <div className="col-md-12">
          ...
          />
          <ComponentToPrint key={datakhachhang.ID} tendichvu={tendichvu} chitietphieudieutri={chitietphieudieutri} datakhachhang={datakhachhang} ketquadieutrilist={ketquadieutrilist} quatrinhdieutrilist={quatrinhdieutrilist}  ref={el => (this.componentRef = el)} />
        </div>
      )
    }
  }
