  ...
  <tr className="dialogMiddle">
    ...
    <td className="dialogMiddleCenter">
      <div className="dialogMiddleCenterInner dialogContent">
        ...
        <div className="printFooter" style={{width: '200px', marginBottom: '5px'}}> <div>QUẢN LÝ PHÒNG NHA</div> <div className="gwt-Label">In lúc {dateTime}</div> </div>
          <div style={{display: 'flex', flexFlow: 'row nowrap', borderBottom: '4px solid #ddd'}}>
            <div style={{marginRight: '10px', alignSelf: 'flex-end', whiteSpace: 'nowrap'}}>
              <div style={{fontSize: '1.55em', fontWeight: 600, textTransform: 'uppercase', display: 'flex', alignItems: 'center'}}>Thôn tin khách khàng</div>
              <div style={{fontStyle: 'italic', margin: '3px 0'}}> <span style={{fontWeight: 600}}>Ngày tạo: {dateTime}</span> <span /> </div>
            </div>
            <div style={{textAlign: 'right', alignSelf: 'flex-end', flexGrow: 1, textTransform: 'capitalize', fontWeight: 300}}>
              <div className="GOK0K1ECMHB GOK0K1ECKHB">Phòng khám Dentist</div>
              ...
              <div className="GOK0K1ECNHB" style={{}}>
                ...
                <div style={{textTransform: 'lowercase'}}><i className="fa fa-envelope" style={{marginLeft: '10px', marginRight: '3px', color: '#999'}} />phongkhamdentist@gmail.com</div>
              </div>
          ...
          <div className="GOK0K1ECGIB" style={{marginTop: '30px'}}>
            ...
            <div style={{display: 'flex', flexFlow: 'row nowrap', alignItems: 'flex-start'}}>
              ...
              <div className="GOK0K1ECHIB" style={{flexGrow: 1}}>{thongtinkhachhang.ID}</div>
            </div>
          </div>
        ...
        if (thongtinkhachhang.gioitinh==="1") {
          ...
          <div className="GOK0K1ECGIB">
            <div style={{display: 'flex', flexFlow: 'row nowrap', alignItems: 'flex-start'}}>
              <div className="GOK0K1ECDIB" style={{marginRight: '10px'}}>Điện thoại</div>
              <div className="GOK0K1ECHIB" style={{flexGrow: 1}}>{thongtinkhachhang.dienthoai}</div>
            </div>
          ...
          <div className="GOK0K1ECGIB">
            ...
            <div style={{display: 'flex', flexFlow: 'row nowrap', alignItems: 'flex-start'}}>
              <div className="GOK0K1ECDIB" style={{marginRight: '10px'}}>Nguồn</div>
              <div className="GOK0K1ECHIB" style={{flexGrow: 1}}>{nguon}</div>
            </div>
          </div>
      
          <div className="GOK0K1ECGIB" style={{alignItems: 'stretch'}}>
            <div style={{display: 'flex', flexFlow: 'row nowrap', alignItems: 'flex-start'}}>
              <div className="GOK0K1ECDIB" style={{alignSelf: 'flex-start', marginTop: '5px', marginRight: '10px'}}>Dịch vụ điều trị</div>
              <table cellSpacing={0} cellPadding={0} className="GOK0K1ECCIB">
                <tbody>
                  
                  {dichvu.map(dv => (
          <tr key={dv.id}>
          <td align="left" style={{verticalAlign: 'top'}}>
            <div style={{fontWeight: 'bold'}}><i className="fa fa-check-square-o" /> <span className="gwt-InlineLabel">{dv.ten}</span></div>
          </td>
        </tr>
        ))}
                </tbody>
            ...
            <div style={{display: 'flex', flexFlow: 'row nowrap', alignItems: 'stretch'}}>
              <div className="GOK0K1ECDIB" style={{alignSelf: 'flex-start', marginTop: '5px', marginRight: '10px'}}> Tiền sử bệnh khác </div>
          ...
          <div className="">
             <div style={{display: 'flex', flexFlow: 'row nowrap', alignItems: 'flex-start', marginTop: '15px'}}>
                 <div className="" style={{marginRight: '10px', marginTop: '5px'}}>Nhu cầu thăm khám</div>
                 <div className="GOK0K1ECHIB" style={{flexGrow: 1, minHeight: '50px'}}>{thongtinkhachhang.gioithieu}</div>
            </div>
      </div>
  ...
  const nguongioithieu=this.props.nguongioithieu
      return (
        ...
        <div className="col-md-12">
          ...
          />
          <ComponentToPrint key={datakhachhang.ID} datakhachhang={datakhachhang} dichvudieutri={dichvudieutri} tiensubenh={tiensubenh} nguongioithieu={nguongioithieu} ref={el => (this.componentRef = el)} />
        </div>
      )
    }
  }
